...
class SelectComenCurtidoA extends GenericaM{  
    ...
    private $sqlSelect = "SELECT titulo_publi, nome_usu, comen_curtida.cod_comen, publicacao.cod_publi, dataHora_comen_curti AS dataHora, comen_curtida.ind_visu_dono_publi
