...
try{
    ...
    if(isset($_GET['pagina'])){ //Ta curtindo atraves da listagem de todas as publicaçoess
        echo "<script> javascript:window.location='view/todasreclamacoes.php?pagina=".$_GET['pagina']."&ID=".$_GET['IDPubli']."';</script>";
    }else{//Ta curtindo atreves da pagina de uma publicacoes especifica
        echo "<script> javascript:window.location='view/todasreclamacoes.php?ID=".$_GET['IDPubli']."';</script>";
    }    
