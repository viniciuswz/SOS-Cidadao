...
function teste(resposta){
    ...
    if(arr1.length > 0){
        ...
        for(i = 0; i < arr1.length; i++){            
            document.getElementById('menu23').innerHTML += "<li class='" + arr1[i]['classe'] + "'> <a href='reclamacao.php?ID="+ arr1[i]['id_publi'] +"&com="+arr1[i]['tipo']+"'><div><i class='"+arr1[i]['tipo']+"'></i></div><span class=''>" + arr1[i]['notificacao'] + "</span></a></li>";            
        }   
    }else{
