...
function teste2(resposta){
    ...
    if(arr1[2]['debateQParticipa'] != ""){
        for(contador=0; contador < arr1[2]['debateQParticipa'].length; contador++){
            mensa2 += "<a class=contatinhos href='../debate_mensagens/"+arr1[2]['debateQParticipa'][contador]['cod_deba']+"'><div class=img-debate><img src='../Img/debate/"+arr1[2]['debateQParticipa'][contador]['img_deba']+"' alt=debate></div><div class=status-debate><p>"+arr1[2]['debateQParticipa'][contador]['nome_deba']+"</p></div><div class=info-contatinho><div class=data_mensagem><p>"+arr1[2]['debateQParticipa'][contador]['dataHora_deba']+"</p></div>";
