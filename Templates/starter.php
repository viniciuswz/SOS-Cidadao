        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="../Img/perfil/<?php echo $resultado[0]['img_perfil_usu'] ?>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown notifications-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span id="quantidade" class="label label-warning"></span>
            </a>
            <ul class="dropdown-menu">
              <li id="header" class="header"></li>
              <li>
                <!-- Inner Menu: contains the notifications -->
                <ul id="menu23" class="menu">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="../Img/perfil/<?php echo $resultado[0]['img_perfil_usu'] ?>" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?php echo $resultado[0]['nome_usu'] ?></span>
            </a>
            <ul class="dropdown-menu">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Meu Perfil</span></a></li>
